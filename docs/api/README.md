...
[Documentation](https://the-node-forge.github.io/jwt-utils/)

 </div>

Welcome to The-Node-Forge **jwt-utils**! This repository serves as a **template** for
The Node Forge members to quickly scaffold a new **TypeScript-based NPM package**
...
- remove any instance of /jwt-utils/ and add your /repo-name/
